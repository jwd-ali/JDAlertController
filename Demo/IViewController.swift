...
class IViewController: UIViewController {
    ...
    private func showErrorAnimated() {
        let alert = AlertController(type:.error, title: "Payment failed!", message: "It seems that we have not received money. You can try again ", preferredStyle: .dragIn)
...
private extension IViewController {
