...
open class AlertController: UIViewController {
    ...
    //MARK:- Views
    fileprivate lazy var mainStack = UIStackViewFactory.createStackView(with: .vertical, alignment: .center, distribution: .fill, spacing: 20, arrangedSubviews: [])
    ...
    private lazy var titleLabel = UILabelFactory.createUILabel(with: titleColor, font: .bodySemibold, alignment: .center, numberOfLines: 0, lineBreakMode: .byWordWrapping)
    ...
    fileprivate lazy var buttonStack = UIStackViewFactory.createStackView(with: .vertical, alignment: .fill, distribution: .fillEqually, spacing: 5)
     ...
     fileprivate lazy var textFieldsStack = UIStackViewFactory.createStackView(with: .vertical, alignment: .fill, distribution: .fillEqually, spacing: 5)
    
    fileprivate lazy var stack = UIStackViewFactory.createStackView(with: .vertical, alignment: .fill, distribution: .fill, spacing: 5, arrangedSubviews: [titleLabel, descriptionLabel])
    ...
    public  init(type:PopupType? = nil,icon: UIImage? = nil, title: String? = nil, message: String? = nil, preferredStyle: PopupStyle = .actionSheet(offset: 0), iconSize: CGFloat = 40) {
...
//    case .topSheet:
//        topSpace += (UIApplication.shared.windows.first{$0.isKeyWindow }?.safeAreaInsets.top ?? 0)/4
//    default:
//        break
//    }
        ...
        .alignEdgeWithSuperviewSafeArea(.top, constant: topSpace)
