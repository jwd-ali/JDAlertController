...
//        logoLayer.path = CGRect(origin: viewCenter, size: CGSize(width: minimum, height: minimum)).drawCheckmarkPath()
...
public extension AnimatedView {
    ...
    func startAnimation(completion: animationCompletion) {
        ...
        let outMostViewPath = UIBezierPath(arcCenter: viewCenter, radius: radius, startAngle: 0, endAngle: 360.degreesToRadians, clockwise: true).cgPath
        
        let middleViewPath = UIBezierPath(arcCenter: viewCenter, radius: radius*0.8, startAngle: 0, endAngle: 360.degreesToRadians, clockwise: true).cgPath
        
        let topViewPath = UIBezierPath(arcCenter: viewCenter, radius: radius*0.6, startAngle: 0, endAngle: 360.degreesToRadians, clockwise: true).cgPath
