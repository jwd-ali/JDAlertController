...
public extension ErrorAnimationLayer {
    func animateLayer(duration: Double, delay: Double, completion: AnimationCompletion) {
        ...
        crossLayerB.rotateAnimationFrames(angels: [0, -165.degreesToRadians, -135.degreesToRadians],
                                          times: [0, 0.7, 1],
                                          duration: duration,
                                          delay: duration+delay,
                                          completion: nil)

        crossLayerA.rotateAnimationFrames(angels: [0, -75.degreesToRadians, -45.degreesToRadians],
                                          times: [0, 0.7, 1],
                                          duration: duration,
                                          delay: duration+delay,
