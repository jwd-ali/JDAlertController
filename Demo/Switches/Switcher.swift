...
@IBDesignable public  class Switcher: BaseControl {
    ...
    fileprivate var thumbRadiusPadding: CGFloat = 5
...
@IBDesignable public class SwitcherFullStrtech: Switcher {
  ...
  @IBInspectable public var thumbTintColor: UIColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1) {
   ...
   override func layoutOffThumbLayer(for bounds: CGRect) {
        ...
        thumbOffLayer.frame = CGRect(x: bounds.maxX - bounds.midY - widthPercent/2,
                                     y: bounds.midY - heightPercent/2,
                                     width: widthPercent,
...
extension SwitcherFullStrtech {
    func layoutInteractionLayerLayer(for bounds: CGRect) {
        ...
        isTouchDown ? ( interactionLayer.frame = bounds ) :
            (isOn ? (interactionLayer.frame = CGRect(x: bounds.maxX - bounds.maxY,
                                                     y: 0,
                                                     width: bounds.maxY,
                                                     height: bounds.maxY)) :
                (interactionLayer.frame = CGRect(x: 0,
                                                 y: 0,
                                                 width: bounds.maxY,
                                                 height: bounds.maxY)))
