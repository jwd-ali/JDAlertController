...
extension PhysicsPanHandler {
    ...
    @objc func pan(_ sender: UIPanGestureRecognizer) {
        ...
        let boxLocation = sender.location(in: messageView)
        ...
        case  .began:
            ...
            animator.removeAllBehaviors()
            let centerOffset = UIOffset(horizontal: boxLocation.x - messageView.bounds.midX, vertical: boxLocation.y - messageView.bounds.midY);
            attachmentBehavior = UIAttachmentBehavior(item: messageView, offsetFromCenter: centerOffset, attachedToAnchor: location)
