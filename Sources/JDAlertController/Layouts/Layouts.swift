...
public extension UIView {
    @discardableResult func alignEdges(_ edges: [ LayoutEdge],
                                       withView view: UIView,
                                       _ constantModifier: LayoutConstantModifier = .equalTo,
                                       constant: CGFloat = 0,
...
public extension UIView {
    @discardableResult func width(_ constantModifier: LayoutConstantModifier = .equalTo,
                                  constant: CGFloat,
                                  priority: UILayoutPriority = .required) -> UIView {
    ...
    @discardableResult func height(_ constantModifier: LayoutConstantModifier = .equalTo,
                                   constant: CGFloat,
                                   priority: UILayoutPriority = .required) -> UIView {
    ...
    @discardableResult func height(with edge: LayoutEdge,
                                   _ constantModifier: LayoutConstantModifier = .equalTo,
                                   ofView view: UIView,
    ...
    @discardableResult func width(with edge: LayoutEdge,
                                  _ constantModifier: LayoutConstantModifier = .equalTo,
                                  ofView view: UIView,
                                  multiplier: CGFloat = 1.0,
                                  constant: CGFloat = 0,
...
public extension UIView {
    ...
    @discardableResult func alignEdgeWithSuperview(_ edge: LayoutEdge,
                                                   _ constantModifier: LayoutConstantModifier = .equalTo,
                                                   constant: CGFloat = 0,
                                                   priority: UILayoutPriority = .required) -> UIView {
        guard let superview = superview else { return self }
    ...
    @discardableResult func alignEdgeWithSuperviewSafeArea(_ edge: LayoutEdge,
                                                           _ constantModifier: LayoutConstantModifier = .equalTo,
                                                           constant: CGFloat = 0,
                                                           priority: UILayoutPriority = .required) -> UIView {
        guard let superview = superview else { return self }
    ...
    @discardableResult func alignAllEdgesWithSuperview(_ constantModifier: LayoutConstantModifier = .equalTo,
    ...
    @discardableResult func alignEdgesWithSuperview(_ edges: [ LayoutEdge],
                                                    _ constantModifier: LayoutConstantModifier = .equalTo,
                                                    constants: [CGFloat],
                                                    priority: UILayoutPriority = .required) -> UIView {
        guard let superview = superview else { return self }
...
public extension UIView {
    @discardableResult func toLeftOf(_ view: UIView,
                                     _ constantModifier: LayoutConstantModifier = .equalTo,
                                     constant: CGFloat = 0,
                                     priority: UILayoutPriority = .required) -> UIView {
    ...
    @discardableResult func toRightOf(_ view: UIView,
                                      _ constantModifier: LayoutConstantModifier = .equalTo,
                                      constant: CGFloat = 0, priority: UILayoutPriority = .required) -> UIView {
        return pinEdge(.left, toEdge: .right, ofView: view, constant: constant, priority: priority)
    }

    @discardableResult func toTopOf(_ view: UIView,
                                    _ constantModifier: LayoutConstantModifier = .equalTo,
                                    constant: CGFloat = 0,
                                    priority: UILayoutPriority = .required) -> UIView {
    ...
    @discardableResult func toBottomOf(_ view: UIView,
                                       _ constantModifier: LayoutConstantModifier = .equalTo,
                                       constant: CGFloat = 0,
                                       priority: UILayoutPriority = .required) -> UIView {
    ...
    @discardableResult func horizontallyCenterWith(_ view: UIView,
                                                   _ constantModifier: LayoutConstantModifier = .equalTo,
                                                   constant: CGFloat = 0,
                                                   priority: UILayoutPriority = .required) -> UIView {
    ...
    @discardableResult func verticallyCenterWith(_ view: UIView,
                                                 _ constantModifier: LayoutConstantModifier = .equalTo,
                                                 constant: CGFloat = 0,
                                                 priority: UILayoutPriority = .required) -> UIView {
    ...
    @discardableResult func alignEdge(_ edge: LayoutEdge,
                                      withView view: UIView,
                                      _ constantModifier: LayoutConstantModifier = .equalTo,
                                      constant: CGFloat = 0,
                                      priority: UILayoutPriority = .required ) -> UIView {
    ...
    @discardableResult func pinEdge(_ edge1: LayoutEdge,
                                    toEdge edge2: LayoutEdge,
                                    ofView view: UIView,
                                    _ constantModifier: LayoutConstantModifier = .equalTo,
                                    constant: CGFloat = 0,
                                    priority: UILayoutPriority = .required) -> UIView {
...
private extension UIView {
    @discardableResult func pinHorizontalEdge(_ edge1: LayoutEdge,
                                              toEdge edge2: LayoutEdge,
                                              ofView view: UIView,
                                              _ constantModifier: LayoutConstantModifier = .equalTo,
                                              constant: CGFloat = 0,
    ...
    @discardableResult func pinVerticalEdge(_ edge1: LayoutEdge,
                                            toEdge edge2: LayoutEdge,
                                            ofView view: UIView,
                                            _ constantModifier: LayoutConstantModifier = .equalTo,
                                            constant: CGFloat = 0,
        ...
        if edge1 == .safeAreaBottomAvoidingKeyboard ||
            edge1 == .bottomAvoidingKeyboard ||
            edge2 == .bottomAvoidingKeyboard ||
            edge2 == .safeAreaBottomAvoidingKeyboard {
    ...
    @discardableResult func pinDimensionEdge(_ edge1: LayoutEdge,
                                             toEdge edge2: LayoutEdge,
                                             ofView view: UIView,
                                             _ constantModifier: LayoutConstantModifier = .equalTo,
        ...
        case .greaterThanOrEqualTo:
            constraint = dimensionAnchor(edge1)
                .constraint(greaterThanOrEqualTo: view.dimensionAnchor(edge2),
